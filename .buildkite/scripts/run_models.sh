...
dbt run --vars '{hubspot_schema: hubspot_sqlw_tests_6, hubspot_marketing_enabled: true, hubspot_contact_merge_audit_enabled: true, hubspot_sales_enabled: false}' --target "$db"
