# dbt_hubspot v0.8.1
## Bug Fixes
- Following the release of `v0.8.0`, the end model uniqueness tests were not updated to account for the added flexibility of the inclusion of deleted records. As such, these uniqueness tests were removed to ensure test failures were not erroneously being thrown. ([#94](https://github.com/fivetran/dbt_hubspot/pull/94))
