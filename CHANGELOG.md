...
## Bug Fixes
- Fixes a type mismatch error in `hubspot__marketing_event_performance` by casting `marketing_event_id` to string on both sides of the joins with `participants_agg`, `lists_agg`, and `custom_properties`.
