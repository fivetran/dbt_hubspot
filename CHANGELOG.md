...
| ------------- | ----------- | --- | --- | ----- |
| `hubspot__daily_deal_history` | New end model | | | Final model. Each record represents a deal's state on a given day with pipeline, stage, amount, owner, team, and other selected properties pivoted into columns. |
